...
const androidRemoteTS = {
  ...
  code: {
    ...
    associatedProjectRecordHintText: '如需录制，先选择项目，关联用例',
    chooseProject: '请选择关联项目',
    chooseModule: '请选择关联模块',
    addCase: '新增用例',
    hintText: '提示',
    recordTypeDisable: '不录制',
    recordTypeAuto: '开启自动录制,默认取第一个xpath',
    recordTypeWithChoose: '开启先选再录制',
    ...
    recordHintText: '请准备好后，点击开始录制，期间可暂停，人工添加步骤后继续录制',
    getEle: '获取控件元素',
    startRecord: '开始录制',
    pauseRecord: '暂停录制',
    continueRecord: '继续录制',
